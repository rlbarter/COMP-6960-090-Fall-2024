...
**Registration**: [Click here to register for this course on Headlamp](https://utah.catalog.instructure.com/browse/ds-learn/courses/introduction-to-r-for-data-analysis). Use code "**RGRANT24**" to waive registration fee. This code is valid only for students registered in this course.
